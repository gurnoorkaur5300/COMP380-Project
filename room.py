...
class Room:
    ...
    @roomNum.setter
    def setRoomNum(self, n_roomNum):
        """
        Sets the room number.
        :param n_name: room number.
        :type n_name: int
        """
        self.roomNum = n_roomNum
    ...
    @location.setter
    def setLocation(self, n_location):
        """
